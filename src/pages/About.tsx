...
const About: React.FC = () => {
  ...
  if (loading) {
    return <div className="about"><div className="loading">Загрузка...</div></div>;
  }

  if (!aboutData) {
    return <div className="about"><div>Информация не найдена</div></div>;
  }
  ...
  return (
    <div className="about">
      ...
      {(aboutData.phone || aboutData.email || aboutData.vk || aboutData.instagram) && (
        <div className="about-contacts">
          <h2>Контакты</h2>
          <div className="contacts-grid">
            {aboutData.phone && (
              <a href={`tel:${aboutData.phone.replace(/[^+\d]/g, '')}`} className="contact-item">
            ...
            {aboutData.email && (
              <a href={`mailto:${aboutData.email}`} className="contact-item">
                <svg className="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            {aboutData.vk && (
              <a href={aboutData.vk} target="_blank" rel="noopener noreferrer" className="contact-item">
            ...
            {aboutData.instagram && (
              <a href={aboutData.instagram} target="_blank" rel="noopener noreferrer" className="contact-item">
                <svg className="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
